...
test('test_can_view_contacts', function () {
...
test('test_can_search_for_contacts', function () {
    $this->actingAs($this->user)
...
test('test_cannot_view_deleted_contacts', function () {
...
test('test_can_filter_to_view_deleted_contacts', function () {
    $this->user->account->contacts()->firstWhere('first_name', 'Martin')->delete();
